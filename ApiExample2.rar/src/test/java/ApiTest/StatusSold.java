...
public class StatusSold {
    @Epic("Тестируем поля c типом string")
    @Feature("StatusPending")
    @Story("Тестируем поле Status для значения Sold ")
    ...
    public void test_1_post() {
        ...
        Assert.assertEquals(result,
                "{\"id\":100,\"category\":{\"id\":0,\"name\":\"AnY\"},\"name\":\"AnY\",\"photoUrls\":[\"AnY\"],\"tags\":[{\"id\":0,\"name\":\"AnY\"}],\"status\":\"sold\"}");

        Assert.assertTrue(result.contains("status\":\"sold"));
    }
